...
r_eng=np.array(np.loadtxt(os.path.join(profile_dir, "R_Rh_0p180.txt")))[:,0]/1e3
rsi_0p18=np.array(np.loadtxt(os.path.join(profile_dir, "R_Si_0p180.txt")))[:,1]
rrh_0p18=np.array(np.loadtxt(os.path.join(profile_dir, "R_Rh_0p180.txt")))[:,1]
