...
class StandardProsilicaWithTIFF(StandardProsilica):
    tiff = Cpt(TIFFPluginWithFileStore,
               suffix='TIFF1:',
               write_path_template=f'{proposal_dir}/legacy/data/%Y/%m/%d/',
               root=f'{proposal_dir}/legacy/data')
...
OAV_writing.tiff.write_path_template = f'{proposal_dir}/legacy/data/%Y/%m/%d/'
OAV_writing.tiff.read_path_template = f'{proposal_dir}/legacy/data/%Y/%m/%d/'
OAV_writing.tiff.reg_root = f'{proposal_dir}/legacy/data/'
